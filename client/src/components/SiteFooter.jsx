      ...
      <div className="site-footer-inner">
        <div className="site-footer-grid">
          <div className="site-footer-brand">
            <Link to="/" className="site-footer-logo" aria-label="Edura LK home">
            ...
            <p className="site-footer-blurb">
              Your shortcut to real university courses: free, audit-friendly, and
              Sri Lankan pathways in one calm directory. Made for students who value
              their time.
            </p>
          ...
          <div className="site-footer-col">
            ...
            <ul className="site-footer-links">
              ...
              <li>
                <Link to="/sri-lanka">Sri Lankan courses</Link>
              </li>
              <li>
        ...
        <div className="site-footer-bottom">
          <p className="site-footer-copy">
            © {year} Edura. Course links go to other sites. Please check access
            and pricing there before you enroll.
          </p>
        </div>
      </div>
    </footer>
